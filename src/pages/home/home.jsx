        ...
        render:(x)=>{
          ...
          let element
            switch(x.index){
              ...
              case 1:
                element=(<div>
                  <img src={require('./icon/1.png')} alt='' style={{width:'24px',height:'24px'}}/>
                </div>)
                break;
                case 2:
                  element=(<div>
                    <img src={require('./icon/2.png')} alt='' style={{width:'24px',height:'24px'}}/>
                  </div>)
                  break;
                  case 3:
                    element=(<div>
                      <img src={require('./icon/3.png')} alt='' style={{width:'24px',height:'24px'}}/>
                    </div>)
                    break;
                default:
                  element=(<div className='div-rad'>
                      {x.index}
                  </div>)
                break
            }
          ...
          <div className="div-layout">
            <div className="panel panel-one">
              <div className="panel-heading">
                ...
                <h3>  <CountUp start={0} end={160526} duration={3} useGrouping={true} separator="," suffix={"￥"} />  </h3>
            ...
            <div className="panel  panel-two" >
              <div className="panel-heading">
                ...
                <h3>  <CountUp start={0} end={1634526} duration={3} useGrouping={true} separator="," suffix={" 个"} />  </h3>
                <div className="div-position">
                  <img src={require("./icon/购物车.png")} alt=''/>  </div>
              </div>
            </div >
            ...
            <div className="panel panel-three">
              <div className="panel-heading">
                ...
                <h3>  <CountUp start={0} end={162566} duration={3} useGrouping={true} separator="," suffix={" 个"} />  </h3>
                <div className="div-position">  <img src={require("./icon/订单.png")} alt=''/>
                </div>
              </div>
            </div>
            ...
            <div className="panel panel-four">
              <div className="panel-heading">
                ...
                <h3>
                  <CountUp start={0} end={34574} duration={3} useGrouping={true} separator="," suffix={" 次"} /> </h3>
                <div className="div-position">
                  < img src={require("./icon/用户.png")} alt='' /> </div>
              </div>
            </div>
          </div>
        </div>
