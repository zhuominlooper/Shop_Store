...
import { reqGetConfCode, reqForgetPwd } from "../../api/index";
import { LockOutlined, VerifiedOutlined ,PhoneOutlined} from '@ant-design/icons';
...
export default class ForgetPwdComponent extends React.Component {
    ...
    componentDidMount=()=>{
        PubSub.subscribe('forgetPwdComponent', (data)=>(this.setState({
            visible:data
        })))
    }
    componentWillUnmount=()=>{
        PubSub.unsubscribe('forgetPwdComponent');
    }
    onClose = () => {
        this.setState({
            visible: false
    ...
    resetPwdSubmit = async (values) => {
        ...
        //注册
        const result = await reqForgetPwd({
            ...
            >
                ...
                >
                    ...
                    <div className="div-float"><Button className="btn-margin" type="primary" onClick={this.getReset}>重置</Button>
                        <Button htmlType="submit" type="primary" >确认</Button></div>
                </Form>
